...
/**
 * Laptop device mockup showing hero section of modernlight.nakespro.id
 * inside a polished device frame. Non-interactive — purely visual preview.
 */
      ...
      <div className="group relative">
        ...
        <div className="relative overflow-hidden rounded-t-xl border border-line shadow-hero">
          ...
          <div className="bg-[#1a1a2e]">
            ...
            {/* Screen — hero preview only, no scroll */}
