...
export const plans = [
  {
    ...
    features: [
      "Bonus domain .web.id atau .my.id untuk paket tahunan",
      ...
      "Layanan bantuan cepat tanggap lewat WhatsApp",
    ],
    cta: "Daftar Sekarang",
  ...
  },
  {
    ...
    yearly: {
      price: "Rp350.000",
      period: "/bulan",
      note: "Ditagih Rp4.200.000/tahun",
    },
    features: [
      "Semua yang ada di Advance plus bonus domain .id",
      "Revisi desain tidak dibatasi demi hasil yang sempurna",
      "Mendukung pengelolaan multi-website untuk banyak cabang",
      "Prioritas utama untuk bantuan teknis dan ketersediaan sistem",
    ],
